        ...
        <form action="{{route('admin.portfolios.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-3 mt-3">
                    ...
                    <input class="mt-2" type="file" name="big_image">
                 </div>
                 <div class="form-group col-md-3 mt-3">
                    <h3>Small Image</h3>
                    <img style="height: 20vh" src="{{asset('pages/assets/img/small_image.jpg')}}" class="img-thumbnail">
                    <input class="mt-2" type="file" name="small_image">
                 </div>
