        ...
        <div class="modal fade" id="editModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="#" method="POST" enctype="multipart/form-data" id="editEmployeeData">
                            @csrf
                            <input type="hidden" value="0" id="empID">
                            <div class="row">
                                <div class="form-group col-md-4 mt-3">
                                ...
                                <div class="form-group col-md-4 mt-3">
                                    <div>
                                        ...
                                        <div id="image_preview">
                                            <img style="height: 30vh" id="previewImg"
                                                src="{{ asset('storage/img/bc_img.jpg') }}" class="img-thumbnail">
                                        </div>

                                        <input class="mt-2" type="file" name="photo" accept="image/*"
                            ...
                            <input type="submit" name="submit" id="btnSubmit" class="btn btn-primary mt-5 add_employee">
                        </form>
                    </div>
                </div>
                <div class="modal-footer">
