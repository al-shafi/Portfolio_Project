...
@section('content')
    <main>
        <div class="container-fluid px-4">
            ...
            <form action="{{ route('newemployees.store') }}" method="POST" enctype="multipart/form-data" id="employeeData">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mt-3">
                        <div>
                            <h3>Photo</h3>
                            <img style="height: 30vh" id="previewImg" src="{{ asset('storage/img/bc_img.jpg') }}"
                                class="img-thumbnail">
